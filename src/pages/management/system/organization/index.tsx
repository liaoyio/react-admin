...
import OrganizationChart from './chart';
...
export default function OrganizationPage() {
  ...
  const rowSelection: TableRowSelection<Organization> = {
    onChange: (selectedRowKeys, selectedRows) => {
      console.log(`🗓️ selectedRowKeys: ${selectedRowKeys}`, 'selectedRows: ', selectedRows);
    },
  ...
  const { data } = useRequest(getOrgList);
...
function OrganizationModal({ title, show, formValue, onOk, onCancel }: OrganizationModalProps) {
  ...
  // FIX organization modal form value not update
  useEffect(() => {
